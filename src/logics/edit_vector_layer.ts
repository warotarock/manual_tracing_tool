...
export class Logic_Edit_Points {
  ...
  static calculateSurroundingRectangle(result: Logic_Edit_Points_RectangleArea, minMaxRectangle: Logic_Edit_Points_RectangleArea, points: List<VectorPoint>, selectedOnly: boolean) {
  ...
  static calculatePointTotalLength(points: List<VectorPoint>, startLength: float) {
  ...
  static calculatePointCurvature(points: List<VectorPoint>) {
  ...
  static calculateSegmentTotalLength(points: List<VectorPoint>, startIndex: int, endIndex: int) {
  ...
  static resamplePoints(result: List<VectorPoint>, points: List<VectorPoint>, startIndex: int, endIndex: int, samplingUnitLength: float): List<VectorPoint> {
    ...
    // for first point
    {
      let sampledPoint = new VectorPoint();
...
export class Logic_Edit_Line {
  ...
  static calculateParametersV(lines: List<VectorStroke>) {
  ...
  static smoothPoints(linePoints: List<VectorPoint>) {
  ...
  static resetModifyStates(lines: List<VectorStroke>) {
...
export class Logic_Edit_VectorLayer {
  ...
  static clearPointModifyFlags(points: List<VectorPoint>) {
