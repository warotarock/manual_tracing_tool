...
import { DirectionInputData, EyesSymmetryInputSideID, InputSideID, JointPartInputData, PosingData, PosingModel } from '../document_data'
...
export class Posing3DLogic {
  ...
  calculateInputLocation3D(result: Vec3, location2D: Vec3, inputSideID: InputSideID, targetData: DirectionInputData, posingData: PosingData, posing3DView: Posing3DView): boolean {
    ...
    return this.calculateInputLocation3DWSide(
  ...
  calculateInputLocation3DWSide(resultFront: Vec3 | null, resultBack: Vec3 | null, location2D: Vec3, centerLocation: Vec3, sphereRadius: float, posingData: PosingData, posing3DView: Posing3DView): boolean {
