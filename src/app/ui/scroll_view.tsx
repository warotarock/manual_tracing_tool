...
export function UI_ScrollView(
  { children, wheelScrollY = 16, direction = 'vertical', shrink = true }: { children, wheelScrollY?: number, direction?: 'vertical' | 'horizontal', shrink?: boolean }
) {
    ...
    return (
        <div ref={containerRef} className={`ui-scroll-view-container ${direction=='vertical' ? 'vertical' : 'horizontal'} ${shrink ? '' : 'no-shrink'}`}
