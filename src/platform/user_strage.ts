...
export class UserStorage {
  ...
  static readonly settingFilePath = 'settings.json'
  ...
  static async load(defaultData: UserStorageData) {
    ...
    try {
      ...
      const text = await Platform.fileSystem.readUserDataFile(this.settingFilePath)
  ...
  static save() {
    ...
    Platform.fileSystem.writeUserDataFile(this.settingFilePath, JSON.stringify(this.data))
      .then()
  }
