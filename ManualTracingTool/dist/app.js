...
(function (ManualTracingTool) {
    ...
    window.onload = function () {
        ...
        _Main.uiMenuButtons = ReactDOM.render(React.createElement(ManualTracingTool.UI_MenuButtons, { context: _Main }), document.getElementById(_Main.ID.mainToolButtons));
        ReactDOM.render(React.createElement(ManualTracingTool.UI_ScrollView, { content: ManualTracingTool.UI_SubToolWindow, wheelScrollY: 32, contentRef: _Main.uiSubToolWindowRef }), document.getElementById(_Main.ID.subtoolWindow));
