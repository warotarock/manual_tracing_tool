...
(function (ManualTracingTool) {
    var Logic_Points = (function () {
        ...
        Logic_Points.pointToLineSegmentDistance = function (point1, point2, x, y) {
            var distance = this.pointToLineSegmentDistanceSQ(point1, point2, x, y);
        ...
        Logic_Points.pointToLineDistance = function (point1, point2, targetPoint) {
        ...
        Logic_Points.pointToLineNearestPoint = function (result, linePoint1, linePoint2, targetPoint) {
