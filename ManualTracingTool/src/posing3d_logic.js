...
(function (ManualTracingTool) {
    ...
    class Posing3DLogic {
        ...
        processMouseInputLocation(result, location2D, targetData, posingData, posing3DView) {
        ...
        calculateBodyPartDirection(inputData, rootMatrix, mode, posingData, posing3DView) {
            ...
            if (mode == Posing3D_BodyLocateMode.keepFrontUp) {
                ...
                ManualTracingTool.Maths.mat4SetVectors(this.yawRotationMatrix, this.vecX, this.vecY, this.vecZ);
                ...
                ManualTracingTool.Maths.mat4SetVectors(this.pitchRotationMatrix, this.vecX, this.vecY, this.vecZ);
        ...
        calculateHeadTwist(posingData, posingModel, posing3DView) {
        ...
        calculateBodyRotation(posingData, posingModel, posing3DView) {
            ...
            if (posingData.bodyRotationInputData.inputDone) {
                ...
                ManualTracingTool.Maths.mat4SetVectors(this.relativeRotationMatrix, this.vecX, this.relativeInputLocation, this.vecZ);
