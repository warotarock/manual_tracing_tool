...
(function (ManualTracingTool) {
    ...
    var Tool_Transform_Lattice_LinePoint = /** @class */ (function (_super) {
        ...
        Tool_Transform_Lattice_LinePoint.prototype.calculateSurroundingRectangle = function (result, env) {
            ...
            var available = ManualTracingTool.Logic_Edit_Points.existsRectangleArea(result);
            return available;
        };
        ...
        Tool_Transform_Lattice_LinePoint.prototype.processLatticeTransform = function (env) {
