...
import { StringLastIndexOf, StringIsNullOrEmpty, ListRemoveAt, ListInsertAt, ListGetRange } from 'base/conversion';
import { LayerTypeID, VectorLayer, LocalSetting, DocumentData, DocumentFileType, DocumentDataSaveInfo, VectorGroup, PosingModel, DocumentBackGroundTypeID } from 'base/data';
...
var App_Document = /** @class */ (function (_super) {
    ...
    function App_Document() {
        ...
        _this.localSetting = new LocalSetting();
        ...
        _this.oraScriptPath = './libs/ora_js/';
    ...
    App_Document.prototype.fixLoadedDocumentData = function (documentData) {
        var info = new DocumentDataSaveInfo();
    ...
    App_Document.prototype.getDocumentFileTypeFromName = function (filePath) {
        var fileType = DocumentFileType.json;
    ...
    App_Document.prototype.createPosingModel = function (modelData) {
        var posingModel = new PosingModel();
    ...
    App_Document.prototype.saveDocumentJsonFile = function (filePath, documentData) {
    ...
    App_Document.prototype.createExportImage = function (documentData, scale, backGroundType) {
        var layout = DocumentData.getDocumentLayout(documentData);
